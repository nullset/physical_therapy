...
function insertFlash() {
 ...
 var quality   = formObj.quality.value;
 var background = formObj.background.value;
 ...
 html += ''
   ...
   + 'border="0" alt="' + file + '" longdesc="quality:' + quality + ';background:' + background + '" title="' + file + '" class="mceItemFlash" />';
