...
var TinyMCE_FlashPlugin = {
	...
	cleanup : function(type, content) {
        ...
        // Parse all object tags and replace them with images from the embed data
        var objects = content.findElementsByTagName('OBJECT');
        ...
        // }
          ...
          embedHTML += ' codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"';
          ...
          embedHTML += '<!--[if !IE]> <-->';
          embedHTML += '<object class="objectInnerObject" data="'+ attribs["title"] +'"';
          embedHTML += ' width="'+ attribs["width"] + '" height="' + attribs["height"] + '" type="application/x-shockwave-flash">';
          embedHTML += '<param name="quality" value="'+ quality + '" />';
          embedHTML += '<param name="pluginurl" value="http://www.macromedia.com/go/getflashplayer" />';
          embedHTML += 'FLASH plugin not installed';
          embedHTML += '</object>';
          embedHTML += '<!--> <![endif]-->';
          embedHTML += '</object>';
