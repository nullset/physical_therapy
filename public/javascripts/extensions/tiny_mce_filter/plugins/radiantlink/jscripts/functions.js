...
function getTargetListHTML(elm_id, target_form_element) {
	...
	html += '<option value="_self">' + tinyMCE.getLang('lang_radiantlink_target_same') + '</option>';
	html += '<option value="_blank">' + tinyMCE.getLang('lang_radiantlink_target_blank') + ' (_blank)</option>';
	html += '<option value="_parent">' + tinyMCE.getLang('lang_radiantlink_target_parent') + ' (_parent)</option>';
	html += '<option value="_top">' + tinyMCE.getLang('lang_radiantlink_target_top') + ' (_top)</option>';
