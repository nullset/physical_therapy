...
tinyMCE.importPluginLanguagePack('radiantimage');

var TinyMCE_RadiantImagePlugin = {
	getInfo : function() {
		return {
			longname : 'Radiant image',
	...
	getControlHTML : function(cn) {
		switch (cn) {
			case "image":
				return tinyMCE.getButtonHTML(cn, 'lang_image_desc', '{$themeurl}/images/image.gif', 'mceRadiantImage');
		}
...
tinyMCE.addPlugin("radiantimage", TinyMCE_RadiantImagePlugin);
